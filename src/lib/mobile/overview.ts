...
export function buildMobileOverview(transactions: DashboardTx[], activity: {
  ...
  return {
    ...
    widget: {
      ...
      totalWorkdays: activityOverview.workdayGauge.totalBillableMonth,
      securedRevenueHtEur: activityOverview.kpis.caEstime,
      securedRevenueTargetHtEur: activityOverview.workdayGauge.totalBillableMonth * activityOverview.tjmEnVigueurHt,
