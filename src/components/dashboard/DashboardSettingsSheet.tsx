    ...
    <>
      ...
      {open ? (
        ...
        >
          ...
          <div
            className={clsx(
              "absolute inset-x-0 bottom-0 flex max-h-[92dvh] flex-col overflow-hidden rounded-t-[2rem] border-t border-ink-200/80 bg-[#f4f7f8] shadow-[0_-24px_80px_-24px_rgba(0,0,0,0.55)] transition-transform duration-300 ease-out dark:border-cyan-100/[0.14] dark:bg-[#0a2b32]",
