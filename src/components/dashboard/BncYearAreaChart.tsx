...
export function BncYearAreaChart({ monthly, formatEuro }: Props) {
  ...
  const cssVars =
    "[--bnc-chart-axis:#8D899D] [--bnc-chart-grid:rgba(52,40,99,0.07)] [--bnc-chart-divider:rgba(52,40,99,0.1)] [--bnc-chart-guide:rgba(16,185,129,0.35)] [--bnc-chart-bnc:#10b981] [--bnc-chart-ik:#0ea5e9] [--bnc-chart-ndf:#f59e0b] [--bnc-chart-marker-fill:#ffffff] [--bnc-chart-tooltip-bg:#F4F1FF] [--bnc-chart-tooltip-muted:#8D899D] [--bnc-chart-tooltip-stroke:rgba(52,40,99,0.08)] [--bnc-chart-tooltip-value:#342863] dark:[--bnc-chart-axis:rgba(255,255,255,0.38)] dark:[--bnc-chart-grid:rgba(255,255,255,0.06)] dark:[--bnc-chart-divider:rgba(255,255,255,0.1)] dark:[--bnc-chart-guide:rgba(52,211,153,0.4)] dark:[--bnc-chart-bnc:#34d399] dark:[--bnc-chart-ik:#38bdf8] dark:[--bnc-chart-marker-fill:#0b3038] dark:[--bnc-chart-ndf:#fbbf24] dark:[--bnc-chart-tooltip-bg:rgba(6,36,43,0.96)] dark:[--bnc-chart-tooltip-muted:rgba(255,255,255,0.48)] dark:[--bnc-chart-tooltip-stroke:rgba(56,189,248,0.22)] dark:[--bnc-chart-tooltip-value:rgba(255,255,255,0.88)]";
  ...
  return (
    ...
    >
        ...
        <g key={`bars-${bar.index}`}>
          {bar.ik.value > 0 ? (
            <rect
              ...
              opacity={activeIndex === bar.index ? 1 : 0.72}
            />
          ) : null}
          {bar.ndf.value > 0 ? (
            <rect
      ...
      {/* Guide vertical mois actif */}
      {hoverPoint && activeIndex != null ? (
        <line
          x1={hoverX}
          y1={BNC_PANEL.top}
          x2={hoverX}
          y2={PERKS_PANEL.bottom}
