            ...
            {geometries
              ...
              .map(({ step, meta }) => {
                ...
                return (
                  <li
                    key={`row-${step.id}`}
                    className="flex items-center justify-between gap-3 rounded-xl border border-ink-200/50 bg-white px-3 py-2.5 shadow-sm dark:border-transparent dark:bg-white/[0.04] dark:shadow-none"
                  >
