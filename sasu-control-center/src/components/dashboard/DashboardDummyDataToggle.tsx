    ...
    <button
      ...
      className={clsx(
        ...
        active
          ...
          : "border-cyan-100/[0.16] bg-cyan-50/[0.10] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.10)] hover:bg-cyan-50/[0.16]"
      )}
    >
      ...
      <span
        className={clsx(
          "absolute bottom-1 right-1 h-2 w-2 rounded-full ring-2 ring-white/80 dark:ring-[#06242b]",
